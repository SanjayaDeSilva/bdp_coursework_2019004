...
public class TotalRentals {
    ...
    public static class NeighbourhoodMapper extends
        ...
        public void map(Object key, Text value, Context context)
            ...
            Map<String, String> parsed = transformCsvToMapForNaiberhood(value
                    .toString());
...
//                        .increment(1);
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (otherArgs.length != 2) {
            System.err.println("Usage: TotalRentals <users> <out>");
            System.exit(2);
        }
        ...
        job.setJarByClass(TotalRentals.class);

        job.setMapperClass(TotalRentals.NeighbourhoodMapper.class);
        ...
        if (code == 0) {
            for (Counter counter : job.getCounters().getGroup(
                    TotalRentals.NeighbourhoodMapper.REGION_COUNTER_GROUP)) {
