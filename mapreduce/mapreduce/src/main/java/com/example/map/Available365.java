...
public class Available365 {
    ...
    public static class AvailabilityMapper extends
        ...
        public void map(Object key, Text value, Context context)
            ...
            Map<String, String> parsed = transformCsvToMapForAvailability(value
                    .toString());
...
//            }
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(Available365.class);

        job.setMapperClass(Available365.AvailabilityMapper.class);
        ...
        if (code == 0) {
            for (Counter counter : job.getCounters().getGroup(
                    Available365.AvailabilityMapper.STATE_COUNTER_GROUP)) {
                System.out.println("available for 365 count:" + "\t"
                        + counter.getValue());
            }
        }
